...
const faqs = [
  ...
  {
    question: "What makes Fix-ISH's AI adaptive?",
    answer: "Our AI learns from each interaction, understanding your skill level, available tools, and preferences to provide increasingly personalized repair guidance.",
  },
  {
    question: "Do you offer team or business accounts?",
    answer: "Yes! Our Enterprise plan includes team collaboration features, API access, and dedicated support. Contact our sales team for custom solutions.",
  },
];
